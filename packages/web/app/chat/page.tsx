...
function ChatThread({
  ...
  const transport = useMemo(
    () => new QBotChatTransport({ api: '/api/chat', body: { model: selectedModel } }),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    []
  );

  // Update body when model changes
  useEffect(() => {
    transport.setBody({ model: selectedModel });
  ...
  return (
    <div className="h-screen flex bg-gray-50 dark:bg-gray-900">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <ChatThread selectedModel={selectedModel} systemPrompt={systemPrompt} />
      </main>
